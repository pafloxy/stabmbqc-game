...
Charlie has been tasked to make the following measurements: $\{X_{1}Z_{3}, X_{3} , Z_{0}Z_{3}\}$.
As before he can discard one of the measurement. 


$\mathrm{Hint}:$ It often helps to move all rotations through clifford operations, to identity angle in/dependent segements. 
